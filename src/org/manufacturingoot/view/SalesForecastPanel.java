...
public class SalesForecastPanel extends javax.swing.JPanel {
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        String id = "";
        SalesForecast selected = null;

        try {
            id = tableData.getValueAt(tableData.getSelectedRow(), 0)
                    .toString();

            selected = new SalesForecastService(emf)
                    .findSalesForecast(Long.parseLong(id));
    ...
    private void openForm(SalesForecast selected) {
        SalesForecastForm temp = new SalesForecastForm(emf, selected);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        try {
            id = tableData.getValueAt(tableData.getSelectedRow(), 0)
                    .toString();
            new SalesForecastService(emf).destroy(Long.parseLong(id));
        } catch (IndexOutOfBoundsException ex) {
